const PUBLIC_APPLICATION_CODES = new Set([
  'BODY_TOO_LARGE', 'CONFLICT', 'CONTEXT_BUDGET_EXCEEDED', 'CONTEXT_SOURCE_UNAVAILABLE', 'CREATE_FAILED',
  ...
  'RUNTIME_START_FAILED', 'RUNTIME_UNSUPPORTED', 'SANDBOX_UNAVAILABLE', 'STALE_PROPOSAL', 'UNAUTHENTICATED',
